...
import pruabTech.Rolando.repository.RolRepository;
import pruabTech.Rolando.repository.UsuarioRepository;
...
public class UsuarioService {
    ...
    public void save(Usuario usuario, MultipartFile imagenFile, boolean encriptaClave) {
        ...
        if (asignarRol) {
            //Si se está creando el usuario, se crea el rol por defecto "USUARIO"
