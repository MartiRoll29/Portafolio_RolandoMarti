...
import pruabTech.Rolando.domain.EstadoFactura;
import pruabTech.Rolando.domain.Factura;
import pruabTech.Rolando.domain.Item;
import pruabTech.Rolando.domain.Producto;
import pruabTech.Rolando.domain.Usuario;
import pruabTech.Rolando.domain.Venta;
import pruabTech.Rolando.repository.FacturaRepository;
import pruabTech.Rolando.repository.ProductoRepository;
import pruabTech.Rolando.repository.VentaRepository;
